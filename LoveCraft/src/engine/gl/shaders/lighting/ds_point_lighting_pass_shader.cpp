#include "ds_point_lighting_pass_shader.h"
#include "util/tool.h"


DSPointLightingPassShader::DSPointLightingPassShader()
{   
}
...
void DSPointLightingPassShader::SetPointLight(const PointLight& Light)
{
