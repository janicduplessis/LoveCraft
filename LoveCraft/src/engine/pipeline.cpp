...
{
    Matrix42 CameraTranslationTrans, CameraRotateTrans, PersProjTrans;
    ...
    return Matrix4f(m_VPTtransformation);
}

const Matrix4f& Pipeline::GetWorldTrans()
{
    Matrix42 ScaleTrans, RotateTrans, TranslationTrans;
    ...
    return Matrix4f(m_WorldTransformation);
}
...
const Matrix4f& Pipeline::GetWVPTrans()
{
    ...
    return Matrix4f(m_WVPtransformation);
}
