...
// THEMES
// Default
#define THEME_DEFAULT_CHAR_H		24.0f
#define THEME_DEFAULT_CHAR_W		12.0f
#define THEME_DEFAULT_CHAR_I		0.6f
#define THEME_DEFAULT_ITALIC		false
#define THEME_DEFAULT_COLOR			TEXTCOLOR_WHITE
#define THEME_DEFAULT_BACK			0
// Main menu
#define THEME_MAIN_MENU_CHAR_H		20.0f
#define THEME_MAIN_MENU_CHAR_W		10.0f
#define THEME_MAIN_MENU_CHAR_I		0.7f
#define THEME_MAIN_MENU_ITALIC		false
#define THEME_MAIN_MENU_COLOR		TEXTCOLOR_YELLOW
#define THEME_MAIN_MENU_BACK		CUSTIMAGE_MENU_BUTTON_BACK
// Console
#define THEME_CONSOLE_CHAR_H		18.0f
#define THEME_CONSOLE_CHAR_W		12.0f
#define THEME_CONSOLE_CHAR_I		0.5f
#define THEME_CONSOLE_ITALIC		false
#define THEME_CONSOLE_COLOR			TEXTCOLOR_RED
#define THEME_CONSOLE_BACK			CUSTIMAGE_CONSOLE_BACK
// Player values
#define THEME_PLAYERVALUES_CHAR_H	20.0f
#define THEME_PLAYERVALUES_CHAR_W	15.0f
#define THEME_PLAYERVALUES_CHAR_I	0.5f
#define THEME_PLAYERVALUES_ITALIC	false
#define THEME_PLAYERVALUES_COLOR	TEXTCOLOR_WHITE
#define THEME_PLAYERVALUES_BACK		0
...
#define PNL_PLAYSCREEN_CONTROLS_NBR	16
#define PNL_PORTRAIT_CONTROLS_NBR	10
...
#define LBL_PLAYER_LEVEL_W			50.0f
#define LBL_PLAYER_LEVEL_H			30.0f
