...
void Matrix42::InitScaleTransform(float ScaleX, float ScaleY, float ScaleZ)
{
...
void Matrix42::InitRotateTransform(float RotateX, float RotateY, float RotateZ)
{
    Matrix42 rx, ry, rz;
...
void Matrix42::InitTranslationTransform(float x, float y, float z)
{
...
void Matrix42::InitCameraTransform(const Vector3f& Target, const Vector3f& Up)
{
    Vector3f N = Target;
    N.Normalise();
    Vector3f U = Up;
...
void Matrix42::InitPersProjTransform(const PersProjInfo& p)
{
...
float Matrix42::Determinant() const
{
